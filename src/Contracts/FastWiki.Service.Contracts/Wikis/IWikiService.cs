...
public interface IWikiService
{
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    Task<PaginatedListBase<WikiDetailDto>> GetWikiDetailsAsync(long wikiId, WikiQuantizationState? state,
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    Task<PaginatedListBase<WikiDetailVectorQuantityDto>> GetWikiDetailVectorQuantityAsync(string wikiDetailId, int page,
        int pageSize);
