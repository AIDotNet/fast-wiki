...
const DesktopChatInput = memo(() => {
  ...
  const { inputHeight, updatePreference } = useGlobalStore();
  ...
  return (
    <DraggablePanel
      ...
      onSizeChange={(_, size) => {
        ...
        updatePreference((typeof size.height === 'string' ? Number.parseInt(size.height) : size.height) ?? CHAT_TEXTAREA_HEIGHT);
      }}
      placement="bottom"
